> [!tip]
> Ten projekt udostępnia środowisko wirtualne oparte na Vagrant, skonfigurowane do uruchomienia maszyny wirtualnej z Ubuntu 22.04 (Jammy) z niezbędnymi narzędziami i skryptami provisioningowymi dostosowanymi do infrastruktury rachuna-net.
...
| `VAGRANT_VM_BASE_IMAGE` | `ubuntu/jammy64`      | Obraz bazowy maszyny wirtualnej               |
